...
export const HighlightedSpan = styled.span<Props>`
  ...
  // (wrapped text has uneven corners unlike figma - could look into using a clipping mask instead
  // - would first ask the designer whether this is needed - time boxed this so didn't get to it)
